const ServiceDiscountIndexResponse = require('../../responses/admin/service-discount/service-discount-index-response');
...
module.exports = {
  index: async (request, response, next) => {
    try {
      const result = await new ServiceDiscountIndexResponse({ request });
