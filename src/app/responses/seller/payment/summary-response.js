...
module.exports = class {
  ...
  async process() {
    try {
      ...
      const totalTopup = await this.totalTransaction({ selector: 'topup' });
      const totalWithdraw = await this.totalTransaction({ selector: 'withdraw' });
      const totalTopupValue = await this.totalCredit({ selector: 'topup' });
      const totalWithdrawValue = await this.totalCredit({ selector: 'withdraw' });
