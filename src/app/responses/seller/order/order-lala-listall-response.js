...
module.exports = class {
  ...
  async process() {
    ...
    const whereCondition = { sellerId: seller.id };

    const total = await this.lalamoveTracking.count({ where: whereCondition });
