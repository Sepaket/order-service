...
const parameterHandler = ({ payload }) => ({
  ...
  shipper_addr1: payload?.sellerLocation?.address?.slice(0, 85) || '',
  shipper_addr2: payload?.sellerLocation?.address?.slice(85, 170) || '',
  shipper_addr3: payload?.sellerLocation?.address?.slice(170, 255) || '',
  ...
  receiver_addr1: payload?.receiver_address.slice(0, 85),
  receiver_addr2: payload?.receiver_address.slice(85, 170),
  receiver_addr3: payload?.receiver_address.slice(170, 255),
  ...
  goods_desc: payload?.goods_content.slice(0, 60) || '',
  goods_amount: payload?.goodsAmount,
  insurance_flag: payload?.is_insurance ? 'Y' : 'N',
  special_ins: payload?.notes.slice(0, 60) || 'FRAGILE',
